...
public class PacketUtilities {
    ...
    public static final int DEFAULT_DATA_LENGTH_ACK_PACKET_ONLY = 4;
    ...
    public static DatagramPacket createEmptyACKPacket(){
        byte[] rawData = new byte[DEFAULT_DATA_LENGTH_ACK_PACKET_ONLY];
        DatagramPacket packet = new DatagramPacket( rawData, DEFAULT_DATA_LENGTH_ACK_PACKET_ONLY);
        return packet;
    }
    ...
    /**
     * This method is used to get the block number from a packet
     * @param packet the target packet
    ...
    /**
     * This method returns the name(string) of a packet
     * @param packet the target packet
